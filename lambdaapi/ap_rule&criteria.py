...
def savecustomersdata(body):
    try:
        ...
        table.execute("select * from AP_Rules")
        headers = [x[0] for x in table.description]
        result = table.fetchall()
